    ...
    return (
      <div className="flex flex-col items-center space-y-5 mx-auto mt-10">
        <p className="text-sm text-gray-500 mx-3">
          Page <span className="mx-1 font-semibold text-gray-300 text-md">
            {page}</span> to
        ...
        <div className="flex items-center">
          <button
            type="button"
            className="bg-gray-800 text-white rounded-l-md 
            border-r border-gray-100 py-2 hover:bg-blue-900 
            duration-300 hover:text-white px-3 
            disabled:cursor-not-allowed disabled:bg-gray-400
             disabled:hover:bg-gray-400"
            disabled={page === 1 || isLoading}
            onClick={onClickPrev}
          >
            <div className="flex flex-row align-middle bg-gray-800">
              <svg className="w-5 mr-2 bg-gray-800 " 
              fill="currentColor" 
              ...
              <p className="ml-2 bg-gray-800">Prev</p>
            </div>
          </button>
          ...
          >
            <div className="flex flex-row align-middle bg-gray-800">
              <span className="mr-2 bg-gray-800">Next</span>
              <svg className="w-5 ml-2 bg-gray-800" fill="currentColor" 
              viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                <path
                  fillRule="evenodd"
